 ...
 * @returns {number} 100
 */
export const findSmallestNumber = (num1, num2) => Math.min(num1, num2);
...
export const calculateLifetimeSupply = (snickersPerDay, age, maxAge) => {
  let snickersInAYear = snickersPerDay * 365;
  let yearsOfLifeLeft = maxAge - age;
  return yearsOfLifeLeft * snickersInAYear;
};
