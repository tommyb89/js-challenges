...
describe("addFurnitureStorLocation() tests", () => {
    ...
    it("Should return an object", () => {
        expect(typeof setFurnitureStoreLocation(table, "Bristol")).toBe(
            "object"
        );
    });
...
describe("makeSpaceship() tests", () => {
    it("Should return an object", () => {
        expect(
            typeof makeSpaceship("rocinante", 8, "epstein drive", true)
        ).toBe("object");
    });
    ...
    it("Should create an object with the provided arguments as values", () => {
        expect(
            makeSpaceship("rocinante", 8, "epstein drive", true)
        ).toStrictEqual(rocinante);
        expect(
            makeSpaceship(
...
describe("setUserName() tests", () => {
    ...
    it("Shouldn't change the username if one already exists", () => {
        ...
        expect(setUserName(user2, "butterflyflowerqueen").username).toBe(
            "killerZ"
        );
...
describe("mergeFurniture() tests", () => {
    ...
    it("Should return an object which has a combination of both keys", () => {
        const testFurniture = mergeFurniture(
            tableLocationInfo,
            tableProductInfo
        );
    ...
    it("Should return an object which has the exact key value pairs of both objects", () => {
        ...
        const testCabinet = mergeFurniture(
            cabinetLocationInfo,
            cabinetProductInfo
        );
